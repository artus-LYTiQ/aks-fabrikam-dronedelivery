...
1. Create the AKS cluster and the Azure Container Registry resource groups.
   ...
   az deployment sub create --name workload-stamp-prereqs --location eastus2 --template-file ./workload/workload-stamp-prereqs.json --parameters resourceGroupName=rg-shipping-dronedelivery resourceGrouplocation=eastus
